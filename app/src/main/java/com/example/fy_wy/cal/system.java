...
public class system extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.menu_one:
                Intent intent1=new Intent(system.this,MainActivity.class);
                startActivity(intent1);
                break;
            case R.id.menu_three:
                Intent intent3=new Intent(system.this,area.class);
                startActivity(intent3);
                break;
            case R.id.menu_four:
                Intent intent4=new Intent(system.this,angle.class);
                startActivity(intent4);
                break;
            case R.id.menu_five:
                Intent intent5=new Intent(system.this,speed.class);
                startActivity(intent5);
                break;
            case R.id.menu_six:
                Intent intent6=new Intent(system.this,system.class);
    ...
    public void shouPup1(View view) {
        ...
        popup.inflate(R.menu.system);
        popup.show();
    }
    public void shouPup2(View view) {
        PopupMenu popup = new PopupMenu(this, view);
        popup.setOnMenuItemClickListener(this);
        popup.inflate(R.menu.system1);
        popup.show();
    }
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.menu_one:
                textview1.setText("二进制");
                break;
            case R.id.menu_two:
                textview1.setText("八进制");
                break;
            case R.id.menu_three:
                textview1.setText("十进制");
                break;
            case R.id.menu_nine:
                textview1.setText("十六进制");
                break;
            case R.id.menu_four:
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.buttonEqual:
                    ...
                    num1 =Integer.valueOf(mystring3);
                    if (mystring1.equals("二进制") && mystring2.equals("二进制")) {
                        editText2.setText(Integer.valueOf(num1));
                    }
                    else if (mystring1.equals("二进制") && mystring2.equals("十进制")) {
                       result=num1;
                        editText2.setText(Integer.valueOf(result));
                    }
                    else if (mystring1.equals("十进制") && mystring2.equals("二进制")) {
                        editText2.setText(Integer.toBinaryString(num1));
                    }
                    else if (mystring1.equals("十进制") && mystring2.equals("十进制")) {
                        editText2.setText(Integer.valueOf(result));
                    }
                    break;
            }
