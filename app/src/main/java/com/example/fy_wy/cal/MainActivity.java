...
public class    MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button but_sin = (Button) findViewById(R.id.buttonSin);
        Button but_cos = (Button) findViewById(R.id.buttonCos);
        ...
        but_sin.setOnClickListener(new MyclickListener());
        but_cos.setOnClickListener(new MyclickListener());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.menu_three:
                Intent intent3=new Intent(MainActivity.this,area.class);
                startActivity(intent3);
                break;
            case R.id.menu_four:
                Intent intent4=new Intent(MainActivity.this,angle.class);
            ...
            case R.id.menu_five:
                ...
                break;
            case R.id.menu_six:
                Intent intent6=new Intent(MainActivity.this,system.class);
